...
const NotesBankSection = () => {
  return (
    <section id="notes-bank" className="py-24 md:py-32 relative bg-secondary/30 overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <span className="text-accent text-sm tracking-[0.3em] uppercase font-sans">Resources</span>
          ...
          <div className="relative animate-fade-in [animation-fill-mode:both]" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative bg-gradient-card rounded-sm border border-accent/20 p-12 md:p-16 text-center shadow-card">
              {/* Animated construction icon */}
              <div className="relative mb-8">
                <div className="w-24 h-24 rounded-full bg-accent/10 border border-accent/30 flex items-center justify-center mx-auto animate-pulse">
                  <Construction className="w-12 h-12 text-accent" />
                </div>
                {/* Orbiting icons */}
                <div className="absolute inset-0 animate-spin" style={{ animationDuration: '20s' }}>
                  <BookOpen className="absolute -top-2 left-1/2 -translate-x-1/2 w-6 h-6 text-accent/40" />
                </div>
                <div className="absolute inset-0 animate-spin" style={{ animationDuration: '25s', animationDirection: 'reverse' }}>
                  <FileText className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-6 h-6 text-accent/40" />
                </div>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border text-sm">
